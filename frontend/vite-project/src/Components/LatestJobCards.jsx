...
const LatestJobCards = ({ company, location, title, salary, jobType, positions, jobId }) => {
  const navigate = useNavigate();

  if (!company || !title || !location) return null; // safety check
  ...
  return (
    <div className="p-6 rounded-xl shadow-lg border border-gray-700 text-white bg-[#111827]">
      ...
      <Button
        className="h-10 mt-4 bg-red-500 text-white px-4 py-2 rounded-lg hover:bg-red-600 transition"
